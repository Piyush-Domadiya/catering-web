      ...
      <div className="max-w-7xl mx-auto px-4 mt-10 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="glass-strong p-10 rounded-[2.5rem] shadow-2xl border border-white/20 relative overflow-hidden group">
              ...
              <div className="space-y-8 relative z-10">
                <div className="flex gap-5 group/item">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-gray-900 dark:text-gray-100 group-hover/item:text-amber-500 transition-colors">
                      events@testful.com
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-5 group/item">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-gray-900 dark:text-gray-100 group-hover/item:text-amber-500 transition-colors leading-tight">
                      Diamond party plot,
              ...
              <div className="mt-12 pt-10 border-t border-gray-100 dark:border-white/10 relative z-10">
                <p className="text-sm font-bold text-gray-900 dark:text-gray-100 mb-6 flex items-center gap-2">
                  Follow Our Journey
                </p>
                <div className="flex gap-4">
                  {[Instagram, Facebook, Twitter].map((Icon, i) => (
                    <button
                      key={i}
                      className="w-12 h-12 rounded-2xl bg-gray-50 dark:bg-black/40 flex items-center justify-center text-gray-400 hover:bg-amber-500 hover:text-white transition-all hover:-translate-y-1 hover:shadow-lg hover:shadow-amber-500/20"
                    >
          ...
          <div className="lg:col-span-2">
            <div className="glass-strong p-10 md:p-16 rounded-[2.5rem] shadow-2xl border border-white/20 h-full relative overflow-hidden">
              ...
              <AnimatePresence mode="wait">
                {!isSuccess ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2 group">
                          <label className="text-sm font-bold text-gray-700 dark:text-gray-300 ml-1 uppercase tracking-wider text-[10px]">
                            Your Name
                          </label>
                          <input
                            required
                            ...
                            className="w-full px-6 py-4 rounded-2xl bg-white/50 dark:bg-black/20 border border-gray-200 dark:border-white/10 focus:bg-white dark:focus:bg-black/40 focus:border-amber-500 focus:outline-none transition-all font-medium dark:text-white placeholder:text-gray-400 backdrop-blur-sm"
                          />
                        </div>
                        <div className="space-y-2 group">
                          <label className="text-sm font-bold text-gray-700 dark:text-gray-300 ml-1 uppercase tracking-wider text-[10px]">
                        ...
                        <div className="space-y-2 group">
                          ...
                          <div className="relative">
                            <select
                              name="eventType"
                              required
                              className="w-full px-6 py-4 rounded-2xl bg-white/50 dark:bg-black/20 border border-gray-200 dark:border-white/10 focus:bg-white dark:focus:bg-black/40 focus:border-amber-500 focus:outline-none transition-all font-medium text-gray-600 dark:text-gray-300 appearance-none backdrop-blur-sm"
                            >
                              <option className="dark:bg-gray-900">
                                Wedding Celebration
                              </option>
                              <option className="dark:bg-gray-900">
                                Corporate Gala
                        ...
                        <div className="space-y-2 group">
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              type="number"
                              placeholder="e.g. 50"
                              className="w-full pl-14 pr-6 py-4 rounded-2xl bg-white/50 dark:bg-black/20 border border-gray-200 dark:border-white/10 focus:bg-white dark:focus:bg-black/40 focus:border-amber-500 focus:outline-none transition-all font-medium dark:text-white placeholder:text-gray-400 backdrop-blur-sm"
                            />
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="space-y-2 group">
                          ...
                          <div className="relative">
                            ...
                            <input
                              name="eventDate"
                              type="date"
                              className="w-full pl-14 pr-6 py-4 rounded-2xl bg-white/50 dark:bg-black/20 border border-gray-200 dark:border-white/10 focus:bg-white dark:focus:bg-black/40 focus:border-amber-500 focus:outline-none transition-all font-medium dark:text-white text-gray-500 backdrop-blur-sm"
                            />
                          </div>
                        </div>
                        <div className="space-y-2 group">
                      ...
                      <button
                        ...
                        type="submit"
                        className="w-full bg-gradient-to-r from-gray-900 to-gray-800 dark:from-amber-500 dark:to-amber-600 text-white py-5 rounded-[2rem] font-bold flex items-center justify-center gap-3 hover:shadow-lg hover:shadow-amber-500/25 active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed group relative overflow-hidden"
                      >
                  ...
                  >
                    ...
                    <p className="text-gray-500 dark:text-gray-400 max-w-sm mx-auto text-lg leading-relaxed mb-12">
