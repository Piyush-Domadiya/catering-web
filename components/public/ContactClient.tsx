...
export function ContactClient({ settings }: ContactClientProps) {
  ...
  const email = settings?.contactEmail || "events@tasteful.com";
  const phone = settings?.contactPhone || "+91 9510616980";
  const address =
    settings?.address || "Diamond party plot,\nkothariya road, Rajkot, Gujarat";
            ...
            <div className="bg-bg-primary p-10 rounded-[2.5rem] shadow-2xl border border-border-color relative overflow-hidden group">
              ...
              <div className="space-y-8 relative z-10">
                <div className="flex gap-5 group/item">
                  ...
                  <div>
                    ...
                    <a
                      href={`mailto:${email}`}
                      className="text-lg font-bold text-text-primary group-hover/item:text-amber-500 transition-colors break-all"
                    >
                      {email}
                    </a>
                  </div>
                ...
                <div className="flex gap-5 group/item">
                  ...
                  <div>
                    ...
                    <a
                      href={`tel:${phone}`}
                      className="text-lg font-bold text-text-primary group-hover/item:text-amber-500 transition-colors"
                    >
                      {phone}
                    </a>
                  </div>
                ...
                <div className="flex gap-5 group/item">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-text-primary group-hover/item:text-amber-500 transition-colors leading-tight whitespace-pre-line">
                      {address}
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-12 pt-10 border-t border-border-color relative z-10">
                ...
                <div className="flex gap-4">
                  ...
                  <button className="w-12 h-12 rounded-2xl bg-bg-secondary dark:bg-bg-tertiary flex items-center justify-center text-text-muted hover:bg-amber-500 hover:text-white transition-all hover:-translate-y-1 hover:shadow-lg hover:shadow-amber-500/20">
                ...
                {!isSuccess ? (
                  ...
                  >
                    ...
                    <p className="text-text-secondary max-w-sm mx-auto text-lg leading-relaxed mb-12">
                      Thank you for choosing Tasteful Affaire. Our events team
                      is already reviewing your details and will call you
                      shortly.
                    </p>
                    <button
